...
require_once '../src/assets/inc/setupdb/setup.php';
            ...
            <?php if (!empty($availableRooms)): ?>
                <?php foreach ($availableRooms as $room): ?>
                    ...
                    switch ($room['room_type']) {
                        case 'Single':
                            echo '../src/forms/singleRoomBooking.php';
                            break;
                        case 'Double':
                            echo '../src/forms/doubleRoomBooking.php';
                            break;
                        case 'King Suite':
                            echo '../src/forms/kingSuiteBooking.php';
                            break;
                        default:
                            echo '../src/forms/defaultRoomBooking.php';
                    }
                    ?>?room_type=<?= urlencode($room['room_type']) ?>&capacity=<?= $room['capacity'] ?>&start_date=<?= urlencode($start_date) ?>&end_date=<?= urlencode($end_date) ?>&guest_count=<?= urlencode($guest_count) ?>" class="room-link">
                        <div class="room-card">
                            <img src="<?php
                            switch ($room['room_type']) {
                                case 'Single':
