...
<div class="container">
    <div class="room-image">
        <img src="../../public/assets/img/double_room.jpg" alt="Dobbelt rom">
    </div>

    <div class="room-details">
        <h2>Dobbelt rom</h2>
        <p><strong>Størrelse:</strong> 50 m²</p>
        <p><strong>Kapasitet:</strong> 2 personer</p>
...
*/
################################################### GAMMEL CHAT-GPT FOR DB-KOMMUNIKASJON ####################################################################
/*
...
// Function to get a random available room ID
function getRandomAvailableRoomId($start_date, $end_date, $conn, $roomType = 'Double') {
    $query = "
        SELECT r.id
        FROM rooms r
...
$assignedRoomId = null;
if ($start_date && $end_date) {
    $assignedRoomId = getRandomAvailableRoomId($start_date, $end_date, $conn, 'Double');
    $_SESSION['assignedRoomId'] = $assignedRoomId; // Store in session
    $_SESSION['start_date'] = $start_date;
    $_SESSION['end_date'] = $end_date;
}
...
<div class="container">
    ...
    <div class="room-details">
        <h2>Dobbelt rom</h2>
        <p><strong>Størrelse:</strong> 30 m²</p>
        <p><strong>Kapasitet:</strong> 2 personer</p>
        <p><strong>Wi-Fi:</strong> Inkludert</p>
    </div>
...
*/
#################################################################### KOMBINERER GAMMEL FUNKSJONALITET MED NY DB-TILKOBLING ####################################################################
...
########################################################## enda nyere faenskap ############################################$_COOKIE

*/

// src/forms/form_doubleRoomBooking.php
...
// Hent tilgjengelige dobbeltrom for de angitte datoene
$availableRooms = $roomModel->getAvailableRoomsByType('Double', $checkInDate, $checkOutDate);

if (empty($availableRooms)) {
    echo "<p>Ingen ledige dobbeltrom for de valgte datoene.</p>";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $bookingModel->createBooking(
            ...
            $selectedRoom['id'],
            'Double', // Romtype
            $selectedRoom['floor'] ?? 2, // Etasje (hentet fra romdata eller standard)
...
<head>
    <meta charset="UTF-8">
    <title>Book Dobbeltrom</title>
    <link rel="stylesheet" href="../../public/assets/css/style.css">
</head>
<body>
<div class="container">
    <h1>Book Dobbeltrom</h1>
